// Centralized Backend API Client Configuration & Base URL
// All requests are routed relative to current origin (/api) by default

export const BACKEND_BASE_URL = "";
export const BACKEND_WS_URL = `ws://${typeof window !== "undefined" ? window.location.host : "localhost:3000"}/ws/tasks`;
